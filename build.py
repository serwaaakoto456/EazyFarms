  ...
  <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-10 mb-10">
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm">
        ...
        <li><i class="fa-solid fa-envelope text-forest-400 mr-2"></i><a href="mailto:eazyfarmshq@gmail.com" class="hover:text-white break-all">eazyfarmshq@gmail.com</a></li>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden" data-aos="fade-up">
      <form id="orderForm" class="p-8 md:p-10" x-show="!orderSuccess"
            @submit.prevent="
              ...
              fetch('https://formsubmit.co/ajax/eazyfarmshq@gmail.com', {
        ...
        <input type="hidden" name="_cc" value="akotonimohchristine@gmail.com,gbagidiezekiel@gmail.com" />
...
<section class="py-20 px-6 md:px-10 bg-gradient-to-b from-white via-brown-50 to-white relative overflow-hidden">
  ...
  <div class="max-w-5xl mx-auto relative">
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <a href="mailto:eazyfarmshq@gmail.com" class="group bg-white rounded-3xl p-8 text-center shadow-lg card-lift border border-gray-100 block" data-aos="fade-up" data-aos-delay="100">
        ...
        <p class="text-gray-900 font-bold text-base mb-1 break-all">eazyfarmshq@gmail.com</p>
